...
task.spawn(function()
    ...
    while gui and gui.Parent do
        hue = hue + 0.003
        if hue > 0.08 then hue = 0.03 end
        pcall(function() Border.BackgroundColor3 = Color3.fromHSV(hue, 0.9, 1) end)
        task.wait(0.03)
    end
end)
                ...
                if p ~= LocalPlayer and p.Character then
                    ...
                    if head and hrp then
                        ...
                        if onScreen then
                            ...
                            box.Color = Color3.fromRGB(255, 80, 40)
                            box.Thickness = 1.2
                            ...
                            name.Text = p.Name
                            name.Color = Color3.fromRGB(255, 200, 180)
                            name.Size = 13
                ...
                if p ~= LocalPlayer and p.Character then
                    ...
                    if hrp then
                        ...
                        if onScreen then
                            ...
                            line.Color = Color3.fromRGB(255, 100, 60)
                            line.Thickness = 0.7
